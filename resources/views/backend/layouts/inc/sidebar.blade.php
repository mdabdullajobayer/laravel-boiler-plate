 ...
 <div class="dlabnav">
     <div class="dlabnav-scroll">
         <ul class="metismenu" id="menu">
             ...
             <li class="mm-active"><a class="has-arrow" href="javascript:void()"
                     aria-expanded="{{ route('home') ? 'true' : 'false' }}">
                     <i class="la la-home"></i>
                     <span class="nav-text">Dashboard</span>
                 </a>
                 <ul aria-expanded="{{ route('home') ? 'true' : 'false' }}"
                     class="{{ route('home') ? 'mm-show' : ' ' }}">
                     <li class="{{ route('home') ? 'mm-active' : ' ' }}">
                         <a href="{{ route('home') }}" class="{{ route('home') ? 'mm-active' : ' ' }}">Dashboard 1</a>
                     </li>
                 </ul>
             </li>
             <li {{ route('home') ? 'mm-active' : ' ' }}><a class="ai-icon {{ route('home') ? 'mm-active' : ' ' }}"
                     href="event-management.html" aria-expanded="false">
             ...
             <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                 ...
                 <ul aria-expanded="false">
                     ...
                     <li><a href="post-details.html">Post Details<span
                                 class="badge badge-danger badge-xs ms-2">NEW</span></a></li>
             ...
             <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                 ...
                 <ul aria-expanded="false">
                     ...
                     <li><a href="uc-lightgallery.html">Light Gallery<span
                                 class="badge badge-danger badge-xs ms-2">NEW</span></a></li>
                 </ul>
             </li>
         ...
         <div class="copyright">
             <p>Edumin Saas Admin © 2024 All Rights Reserved</p>
